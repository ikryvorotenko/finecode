        ...
        <section className="w-full min-h-screen bg-white dark:bg-gray-900">
            <div className="container relative flex flex-col min-h-screen px-6 py-8 mx-auto">
                    ...
                    <div className="flex flex-col w-full gap-5 md:gap-10">
                        <div>
                            ...
                            <p className="max-w-3xl mx-auto mt-6 text-lg text-center text-gray-700 dark:text-white md:text-2xl">
                                Software development of file quality
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <input id="email" type="text"
                                   className="px-6 py-3 text-gray-700 bg-white border rounded-3xl dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2"
                                   placeholder="Email Address"/>

                            <button
                                className="px-8 py-3 text-sm font-medium tracking-wide rounded-3xl text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-600 focus:bg-blue-600 focus:outline-none sm:mx-2">
                                contact me
                            </button>
                        </div>
                ...
                <footer className="flex flex-col items-center mt-12 sm:flex-row sm:justify-center">
                    ...
                    <a href="mailto:office@finecode.nl"
                       className="px-4 text-gray-700 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400">office@finecode.nl</a>
                </footer>
            </div>
        </section>
    )
